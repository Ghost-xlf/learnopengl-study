...
int main()
{
  ...
  Shader ourShade("./src/12-drop-light/shader/vertex.glsl", "./src/12-drop-light/shader/fragment.glsl");
  Shader lightObjectShader("./src/12-drop-light/shader/light_object_vert.glsl", "./src/12-drop-light/shader/light_object_frag.glsl");
