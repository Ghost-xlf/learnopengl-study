...
int main()
{
  ...
  Shader ourShade("./src/10-ligthing/shader/vertex.glsl", "./src/10-ligthing/shader/fragment.glsl");
  Shader lightObjectShader("./src/10-ligthing/shader/light_object_vert.glsl", "./src/10-ligthing/shader/light_object_frag.glsl");
