...
int main()
{
  ...
  Shader ourShade("./src/11-lightMap/shader/vertex.glsl", "./src/11-lightMap/shader/fragment.glsl");
  Shader lightObjectShader("./src/11-lightMap/shader/light_object_vert.glsl", "./src/11-lightMap/shader/light_object_frag.glsl");
