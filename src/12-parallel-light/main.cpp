...
int main()
{
  ...
  Shader ourShade("./src/12-parallel-light/shader/vertex.glsl", "./src/12-parallel-light/shader/fragment.glsl");
  Shader lightObjectShader("./src/12-parallel-light/shader/light_object_vert.glsl", "./src/12-parallel-light/shader/light_object_frag.glsl");
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    ourShade.setVec3("lightPos", -0.0f, -0.0f, -0.3f); // 注意不能写在下方  glDrawElements 后输入的参数会是下一个着色器片段
